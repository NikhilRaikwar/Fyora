...
export const Route = createFileRoute("/explore")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover creators building on Fyora and support them from any chain." },
  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 pt-12 pb-8">
        <Sticker color="lilac" rotate={-3}>The directory</Sticker>
        <h1 className="font-display text-6xl italic mt-3">Meet the creators.</h1>
        <p className="text-muted-foreground mt-2 max-w-lg">
          Indie hackers, artists, streamers, and open-source heroes. Send them a
          little something.
        </p>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 pb-24">
          ...
          {filtered.map((c, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 font-display text-3xl italic leading-tight">
                  {c.name}
                </div>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-16 text-muted-foreground">
            No one by that name yet. <Link to="/onboard" className="underline">Claim it?</Link>
          </div>
        )}
      </section>
    </div>
